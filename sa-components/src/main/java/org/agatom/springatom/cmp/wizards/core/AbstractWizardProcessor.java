...
abstract class AbstractWizardProcessor {
    ...
    @Autowired
    @Qualifier("validator")
    protected            Validator                   delegatedValidator = null;
    @Autowired
    ...
    private              Validator                   localValidator     = null;
     ...
     *
     * @return local {@link org.agatom.springatom.cmp.wizards.data.result.WizardResult}
     *
    ...
    /**
     * Returns true only if {@link org.agatom.springatom.cmp.wizards.Wizard#validate()} is true
     *
     ...
     * <li>particular {@link org.agatom.springatom.cmp.wizards.StepHelper} returns true for validation question</li>
     * </ol>
     *
     ...
     * @see org.agatom.springatom.cmp.wizards.core.StepHelperDelegate#isValidationEnabled(String)
     * @see org.agatom.springatom.cmp.wizards.StepHelper#isValidationEnabled()
     */
    ...
    /**
     * Creates {@link org.agatom.springatom.cmp.wizards.data.result.FeedbackMessage#newError()} message out of {@link org.springframework.validation.ObjectError}.
    ...
    /**
     * By default this method returns {@link org.agatom.springatom.cmp.wizards.WizardProcessor#DEFAULT_FORM_OBJECT_NAME}.
     ...
     * some method to be automatically routed to the appropriate {@link org.agatom.springatom.cmp.wizards.StepHelper}
     * via {@link org.agatom.springatom.cmp.wizards.core.StepHelperDelegate}
     *
     ...
     * through it instead of via {@link org.agatom.springatom.cmp.wizards.validation.ValidationService}.
