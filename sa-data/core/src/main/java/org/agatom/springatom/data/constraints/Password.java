 ...
 * <ol>
 * <li>not null {@link String}</li>
 * <li>{@link String} which length is between <b>6</b> and <b>20</b> inclusively</li>
 * <li>{@link String} that matches following pattern=<i><pre>((?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%]))</pre></i>
 * <ol>
