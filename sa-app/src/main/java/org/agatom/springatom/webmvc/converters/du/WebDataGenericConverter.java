 ...
 * <li>target: {@link String}, because {@link org.agatom.springatom.webmvc.converters.du.WebDataConverter} returned value will be translated to {@link String}</li>
 * </ol>
 *
...
//        final PersistentEntity<?, ?> entity = this.mappingContext.getPersistentEntity(persistable.getClass());
//
//        // 1. Check if it is an multi association from persistable
//        PersistentProperty<?> attribute = null;
//        try {
//            assert entity != null;
//            attribute = entity.getPersistentProperty(key);
//        } catch (Exception ignore) {
//        }
//        if (attribute == null) {
//            return key;
//        }
//        if (attribute.isCollectionLike() && attribute.isAssociation()) {
