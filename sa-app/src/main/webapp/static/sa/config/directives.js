...
define(
    [
        ...
        'directives/cmp/ip/textInfoPageAttribute',
        'directives/cmp/ip/linkInfoPageAttribute',
        'directives/cmp/ip/gridInfoPageAttribute',
        'directives/cmp/wiz/header',
        'directives/cmp/wiz/actions',
        'directives/cmp/wiz/nbox',
        'directives/stacktrace/stacktrace',
        'directives/button/actionButtons',
        'directives/restValue',
        'directives/breadcrumb/breadcrumb',
        'directives/header/directive',
        'directives/header/userMenu/directive'
        // directives
    ],
