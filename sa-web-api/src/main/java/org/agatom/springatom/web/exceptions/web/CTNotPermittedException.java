 ...
 * @since 0.0.1
 */
final public class CTNotPermittedException
        extends WebException {
    private static final long serialVersionUID = 5022753847835360618L;

    public CTNotPermittedException(final String message) {
        super(message);
    }

    public CTNotPermittedException(final Throwable cause) {
        super(cause);
    }

    public CTNotPermittedException(final String message, final Throwable cause) {
        super(message, cause);
    }
