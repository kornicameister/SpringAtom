 ...
 * Each entry is populated in the separate insert statement using {@link org.agatom.springatom.populators.DatabaseEnumPopulable#getColumns()}
 * to determine
 * target columns and {@link org.agatom.springatom.populators.DatabaseEnumPopulable#getData()} to set the data for the
 ...
 * org.agatom.springatom.populators.DatabaseEnumPopulable#getTable()} value.
 *
 * @author kornicameister
 * @version 0.0.1
 * @since 0.0.1
 */
public class EnumDatabasePopulator implements DatabasePopulator {
