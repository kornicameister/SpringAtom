...
abstract class AbstractRBuilderCreateOperation
	 ...
	 *
	 * @param reportConfiguration configuration to be used
	 *
	 * @throws ReportCreateOperationException if any assertion fails
	 ...
	 *
	 * @param reportConfiguration configuration to be used
	 * @param user                current user in {@link org.springframework.security.core.context.SecurityContext#getAuthentication()}
	 * @param locale              current locale retrieved from {@link org.springframework.context.i18n.LocaleContextHolder}
	 * @param propertiesHolder    {@code rbuilderProperties} as {@link java.util.Properties}
	 *
	 * @return new report instance
	 *
	 * @throws org.agatom.springatom.web.rbuilder.data.exception.InSaveReportCreateOperationException if any.
	 */
	...
	/**
	 * Validates report configuration according to the requirements represented by specific {@link org.agatom.springatom.web.rbuilder.data.operation.create.RBuilderCreateOperation}
	 *
	 * @param reportConfiguration {@link org.agatom.springatom.web.rbuilder.ReportConfiguration} to be persisted
	 *
