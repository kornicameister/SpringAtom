 ...
 * <li>{@link #onWizardInit(java.util.Locale)}} updated to check for {@link java.lang.Exception} and if any would be thrown returned appropriate {@link org.agatom.springatom.web.wizards.data.result.WizardResult}</li>
...
abstract public class CreateObjectWizardProcessor<T>
    ...
    @Override
    public final WizardResult onWizardInit(final Locale locale) throws SException {
     ...
     * @see org.agatom.springatom.web.wizards.data.context.DataScope#STEP
     * @see org.agatom.springatom.web.wizards.data.result.WizardResult#addStepData(Object)
     */
