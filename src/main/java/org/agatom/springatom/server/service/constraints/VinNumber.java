...
import org.agatom.springatom.server.service.constraints.impl.VinNumberValidator;
...
public @interface VinNumber {
    String message() default "{org.agatom.springatom.server.service.constraints.VinNumber}";
