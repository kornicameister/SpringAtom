 ...
 * @since 0.0.1
 */
public interface SAppointmentWorkerLinkBuilder
        extends Builder<SAppointmentWorkerLink> {
    SAppointmentWorkerLinkBuilder withAppointment(final SAppointment appointment);

    SAppointmentWorkerLinkBuilder withAssignee(final SMechanic assignee);

    SAppointmentWorkerLinkBuilder withReporter(final SIssueReporter reporter);
}
