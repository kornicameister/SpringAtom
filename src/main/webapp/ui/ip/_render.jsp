...
<jsp:useBean id="ipBuilder" scope="request" type="org.agatom.springatom.ip.component.builder.DomainInfoPageComponentBuilder"/>
...
<jsp:useBean id="data" type="org.agatom.springatom.ip.data.EntityDataResponse" scope="page"/>
