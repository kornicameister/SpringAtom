...
/**
 * {@code DevProfile} marks annotated class as candidate for autowiring only in {@code dev} profile
 *
 * <p>
...
@Profile(DevProfile.PROFILE_NAME)
public @interface DevProfile {
    String PROFILE_NAME = "sa_profile_dev";
}
